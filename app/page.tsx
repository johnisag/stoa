...
const NAV_KEYBINDINGS: Keybinding[] = [
  ...
  // (left/right are the tab-nav chords, NOT allowInInput). On Windows/Linux xterm
  // WOULD emit a modified-arrow escape for Ctrl+Shift+ArrowUp/Down, so the
  // Terminal's custom key handler (websocket-connection.ts) swallows JUST those
  // two before xterm sees it — the escape never reaches the pty, and this
  // bubble-phase keybinding still fires.
  {
