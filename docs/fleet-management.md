...
| ------------------------------------------------- | ----------- | ----------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Phase 0: Plan and loop                            | PR open     | `codex/fleet-management-loop` | Local gate green on branch head: `npx prettier --check .`, `npx tsc --noEmit`, `npm test` (306 files, 3539 tests), and `npm run build` pass with existing Turbopack warning; four-agent review clean after adversarial fixes; PR #391 exists and requires live head-SHA/CI recheck before merge | Pending after merge: merge SHA, final CI result, and `Completed` status | Refresh branch if needed, wait for CI on final PR head, request operator authorization to mark ready/merge, merge only the authorized head SHA, then run bookkeeping reconciliation through the gated bookkeeping PR path | Creates the durable plan, framework evaluation, visible execution contract, state ledger, and phase loop.                                                                                       |
| Phase 1: Durable model and read-only UI           | Not started | TBD                           | Required: full local gate + four-agent review + CI                                                                                                                                                                                                                                              | Pending future phase merge                                              | Await operator authorization after Phase 0 merges                                                                                                                                                                         | Must not spawn workers. Operator acceptance target: Fleet Management entry opens to an empty state, draft-run create flow, approval preview, and read-only run graph over seeded/imported data. |
| Phase 2: Plan ingestion and decomposition         | Not started | TBD                           | Required: full local gate + four-agent review + CI                                                                                                                                                                                                                                              | Pending future phase merge                                              | Pending Phase 1                                                                                                                                                                                                           | Plan approval and critic artifacts only.                                                                                                                                                        |
| Phase 3: Scheduler and worker launch              | Not started | TBD                           | Required: full local gate + four-agent review + CI                                                                                                                                                                                                                                              | Pending future phase merge                                              | Pending Phase 2                                                                                                                                                                                                           | Requires leases, idempotent spawn, startup recovery, resource admission, and 40 fake-worker perf test before real launch.                                                                       |
